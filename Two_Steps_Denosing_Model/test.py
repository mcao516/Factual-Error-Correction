...
def main():
    ...
    parser.add_argument("--results_dir", default="./", type=str,
                        help="Path to write prediction resutls.")
    ...
    # write_results(args.results_dir, guids, preds)
    # args.logger.info("Save results at: {}/predictons.txt".format(args.results_dir))
